...
void setup() {
  ...
  /*Particle.subscribe("liquidLevel", liquidoutput, "310039000f51353338363333"); //momo's photon*/
  Particle.subscribe("photoCell", lightoutput, "310039000f51353338363333");
  Particle.subscribe("moisture", soiloutput, "310039000f51353338363333");
  Particle.subscribe("eventsucceed", eventsucceed, "310039000f51353338363333");
  Serial.begin(9600);
}
