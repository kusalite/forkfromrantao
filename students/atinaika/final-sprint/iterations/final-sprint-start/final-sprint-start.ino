...
// confirmed
int delayBeforeSelection = 1500;//User must press the strip for 2 seconds to activate
...
void doConfirmationState()
{
  ...
  if( currentSelection > 0 ){
    ...
    String sms_message = "Advait is meditating till "+String(meditationEndHour)+":"+String(meditationEndTime)+" "+meditationEndAmPm;
